          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-6 text-balance text-base leading-relaxed text-muted-foreground sm:text-lg">
                Whether you&apos;re exploring ERP for the first time or looking to upgrade your
                current systems, our team is ready to help. Reach out and we&apos;ll get back to you
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-border bg-background p-6">
                ...
                <p className="mt-3 text-sm font-semibold">Call us</p>
                <a
              ...
              <div className="rounded-xl border border-border bg-background p-6 sm:col-span-2">
                ...
                <p className="mt-3 text-sm font-semibold">Visit us</p>
